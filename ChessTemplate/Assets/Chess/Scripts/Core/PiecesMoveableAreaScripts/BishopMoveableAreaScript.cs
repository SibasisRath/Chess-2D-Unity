...
{
    public class BishopMoveableAreaScript : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            m_PlayerPlacementHandler.OnSelectedValueChange += BishopMovements;
        }
        ...
        private void BishopMovements(bool isSelected)
        {
            if (isSelected)
            {
        ...
        private void HighlightHorizontalAndVerticalTiles(int startRow, int startCol, int rowStep, int colStep)
        {
            ...
            while (IsInBounds(updatedRow, updatedCol) && CheckForAnyPieceInBishopsPath(updatedRow, updatedCol))
            {
                updatedRow += rowStep;
                updatedCol += colStep;
            }
        ...
        private bool CheckForAnyPieceInBishopsPath(int newRow, int newCol)
        {
